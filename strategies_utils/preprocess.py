...
class PreProcess:
    ...
    def execute_function(self, func, args: dict = {}) -> callable:
        self.pipeline_func_.append({"execute_function": {"func": func}})
        self.X = func(self.X, **args)
        return self

    def add_feature(self, varname: str, init_value) -> callable:
    ...
    def set_type_var(self, varname: str, type: str):
    ...
    def create_var_relation(self, var1: str, var2: str, operation: str) -> callable:
        self.pipeline_func_.append(
            {
                "create_var_relation": {
                    "var1": var1,
    ...
    def fillna_var(self, varname: str, impute_val: float) -> callable:
        self.pipeline_func_.append(
    ...
    def apply_pipeline(self, module: __module__):
        preprocess_object = PreProcess(self.__X__)
